...
## Using this repo to create MERN-Stack Projects in the future: 
1. Clone the mern-infrastructure repo: `git clone git@github.com:ianpetercreative/mern-infrastructure.git name-of-project` 
